...
class ManifestGenerator
	...
	def filenameGen()
		if @trim == 'r'
			...
			@fileName = "#{$targetPath}\\Generated EVS Files\\autogenerated_#{@mailClass}_#{@date}_RateTest"
		elsif @trim == 'f'
			...
			@fileName = "#{$targetPath}\\Generated EVS Files\\autogenerated_#{@mailClass}_#{@date}_FeeTest"
		else
			...
			@fileName = "#{$targetPath}\\Generated EVS Files\\autogenerated_#{@mailClass}_#{@date}#{@time}"
		end
	end
	#*********************************************************************************************************************************
